    ...
    dataReviews = elDataReviews.DataTable({
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            var $name = full.userId?.username,
              $number = full.userId?.number ? full.userId.number : full.userId.email,
              $avatar = full.userId?.avatar;
      ...
      responsive: {
        details: {
          display: $.fn.dataTable.Responsive.display.modal({
            header: function (row) {
              var data = row.data();
              return 'Details of ' + data['userId'].username;
            },
          }),
          type: 'column',
