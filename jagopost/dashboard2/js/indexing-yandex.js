$(function () {
  ...
  $('.btn-logout').click(function () {
    Swal.fire({ text: 'Are you sure you want to log out of your Yandex account?', icon: 'warning', showCancelButton: !0, confirmButtonText: 'Yes', customClass: { confirmButton: 'btn btn-primary me-2', cancelButton: 'btn btn-label-secondary' }, buttonsStyling: !1 }).then(function (e) {
      if (e.value) {
